...
os.system("python ~/working/prog_scripts/run_bubble_correction-hires.py "+str(big_f) )
os.chdir(inputdir_small)
os.system("python ~/working/prog_scripts/run_bubble_correction-hires.py "+str(small_f) )

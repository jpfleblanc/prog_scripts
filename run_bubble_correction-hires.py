...
def main(argv):
	...
	os.system("~/working/prog_scripts/bubble_code/bubble --input_dmft_file ../../Greens_17.h5 --input_df_file output.h5 --kpts 64 --nfermi "+nfermi+" --nbose 33 --beta 5 --output_file bubble.h5")

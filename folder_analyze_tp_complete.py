			...
			if os.path.exists(DF_running_path)==False:
				...
				#	print("I am in " + os.getcwd())	
					...
					if os.path.exists(os.getcwd()+"/output.h5")==False or rerun_DF==True:
						...
						os.system("$HOME/alps_core/opendf/install/bin/hub_df_square_nnn --input qmc_output.h5 --nbosonic 32 --df_sc_cutoff 1.0e-8 --df_sc_iter 1200 --df_sc_mix 0.05  --mu "+str(mu) +" --tp "+str(tprime)+" --resume 1")

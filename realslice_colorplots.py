...
numpy.savetxt('realslice1.dat',slice1)
numpy.savetxt('realslice2.dat',slice2)
numpy.savetxt('realslice3.dat',slice3)
numpy.savetxt('realslice4.dat',slice4)
numpy.savetxt('realslice5.dat',slice5)

		...
		for folder_item in temp_mu_folders:
			...
			#	print("I am in " + os.getcwd())	
				...
				if os.path.exists(os.getcwd()+"/qmc_output.h5")==False:
					options_str="--mu 0 --vertex ../vert_F_phpp --gw_real ../../G_omegareal_18 --gw_imag ../../G_omega_18 --sigma ../../selfenergy_18"
				...
				if os.path.exists(os.getcwd()+"/output.h5")==False or rerun_DF==True:
					os.system("/home1/03773/jamesleb/alps_core/opendf/install/bin/hub_df_cubic2d --input qmc_output.h5 --nbosonic 15 --df_sc_cutoff 1.0e-6 --df_sc_iter 50 --df_sc_mix 0.4 --fluct_diag 1 --mu "+str(mu))

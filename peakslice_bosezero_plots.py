...
numpy.savetxt('sliceBose1.dat',slice1)
numpy.savetxt('sliceBose2.dat',slice2)
numpy.savetxt('sliceBose3.dat',slice3)
numpy.savetxt('sliceBose4.dat',slice4)
numpy.savetxt('sliceBose5.dat',slice5)

...
os.system("python ~/working/prog_scripts/run_bubble_correction.py "+str(big_f)+" "+beta+" "+kpts )
os.chdir(inputdir_small)
os.system("python ~/working/prog_scripts/run_bubble_correction.py "+str(small_f)+" "+beta+" "+kpts )
